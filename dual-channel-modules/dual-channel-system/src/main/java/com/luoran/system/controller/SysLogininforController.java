...
import com.luoran.system.domain.SysLogininfor;
import com.luoran.system.service.ISysLogininforService;
...
public class SysLogininforController extends BaseController {
    ...
    public AjaxResult add(@RequestParam("username") String username, @RequestParam("status") String status,
        ...
        logininfor.setInfoId(PrimaryKeyIdUtils.getSysIdWorker().nextId());
